...
public final class SlimefunExtended {
    ...
    public static boolean checkEnvironment(@Nonnull Slimefun sf) {
        try {
            ...
            // sf.getLogger().log(Level.WARNING, "Could not identify the server version you are using :(");
            // return false;
        }
        ...
        if (EnvironmentChecker.checkHybridServer()) {
            ...
            sf.getLogger().log(Level.WARNING, "");
            sf.getLogger().log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            sf.getLogger().log(Level.WARNING, "Hybrid server software detected, Slimefun will be disabled!");
            sf.getLogger().log(Level.WARNING, "Hybrid servers have been reported to cause issues by multiple users,");
            sf.getLogger().log(Level.WARNING, "forcing this check to be bypassed is not supported.");
            sf.getLogger().log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            sf.getLogger().log(Level.WARNING, "");
            sf.getLogger().log(Level.WARNING, "#######################################################");
            return false;
        ...
        if (Slimefun.getConfigManager().isBypassEnvironmentCheck()) {
            ...
            sf.getLogger().log(Level.WARNING, "Unsupported environments will not receive support.");
            sf.getLogger().log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            sf.getLogger().log(Level.WARNING, "");
            sf.getLogger().log(Level.WARNING, "#######################################################");
            return true;
