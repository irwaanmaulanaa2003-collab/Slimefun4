    ...
    private static void addHeader(Player p, ChestMenu menu, ItemStack guide) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&fModified build by StarWishsama",
                        "&cDo not report bugs to Slimefun using this build info",
                        "&cPlease report issues on this fork first",
                        "",
                        ...
                        "&fTranslated by: &aAcheater_ &7and &aMybezo"),
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Last active: &a" + NumberUtils.getElapsedTime(github.getLastUpdate()) + " ago",
                        "&7Forks: &e" + github.getForks(),
                        "&7Stars: &e" + github.getStars(),
                        "",
                        "&7&oSlimefun 4 is a community-driven project,",
                        "&7&oand the source code is available on GitHub.",
                        "&7&oIf you want to keep this project alive,",
                        "&7&oconsider contributing to the project.",
                        "",
                        "&7\u21E8 &eClick to open the GitHub repository"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Do you need help with items or machines?",
                        "&7Not sure what to do?",
                        "&7Check our community-maintained Wiki",
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Slimefun is a big project, but addons",
                        "&7are what make Slimefun truly shine.",
                        "&7Take a look, maybe you will find the addon you need!",
                        "",
