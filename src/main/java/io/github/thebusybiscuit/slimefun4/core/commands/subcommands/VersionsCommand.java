...
class VersionsCommand extends SubCommand {
     ...
     */
    private static final String JAVA_VERSION_NOTICE = "Java 16+ is required for Minecraft 1.17!";
    ...
    public void onExecute(@Nonnull CommandSender sender, @Nonnull String[] args) {
        if (sender.hasPermission("slimefun.command.versions") || sender instanceof ConsoleCommandSender) {
            ...
            builder.append(Component.text("Server environment for Slimefun:\n", Style.style(NamedTextColor.GRAY)))
            ...
            builder.append(Component.text("\nModified build by StarWishsama", Style.style(NamedTextColor.WHITE)))
                    .append(Component.text("\nTranslated by Acheater_ and Mybezo", Style.style(NamedTextColor.GREEN)))
                    .append(Component.text(
                            "\nDo not report this unofficial build to the Slimefun developers.\nPlease report issues on this fork first.\n", Style.style(NamedTextColor.RED)));
            ...
            if (Bukkit.getPluginManager().isPluginEnabled(plugin)) {
                ...
                if (plugin instanceof SlimefunAddon addon && addon.getBugTrackerURL() != null) {
                    ...
                    try {
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text("Author: ", NamedTextColor.YELLOW))
                                .append(Component.text(authors, NamedTextColor.YELLOW))
                                .append(Component.text("\n> The addon provided an invalid bug tracker URL!", NamedTextColor.RED))
                                .build();
                ...
                if (plugin instanceof SlimefunAddon addon && addon.getBugTrackerURL() != null) {
                    try {
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text("This plugin is disabled.\nPlease check the console for errors.", NamedTextColor.RED))
                                .append(Component.text("\n> The plugin provided an invalid bug tracker URL", NamedTextColor.DARK_RED))
                                .build();

                        hoverEvent = HoverEvent.showText(hoverComp);
                    }
                } else {
                    Component hoverComp = Component.text("The plugin is disabled, please check the console for errors.");
                    hoverEvent = HoverEvent.showText(hoverComp);
                }
            }
