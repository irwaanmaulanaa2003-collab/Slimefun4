...
public final class VersionedBiome {
    ...
    static {
        ...
        try {
            ...
            Slimefun.logger().severe("Failed to initialize biome compatibility: " + e.getMessage());
        }
    ...
    public static Biome valueOf(@Nonnull String biomeName) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not call Biome.valueOf: " + biomeName, e);
        }
        throw new IllegalArgumentException("Biome.valueOf is unavailable");
    }
}
